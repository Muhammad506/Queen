...
const Hero = () => {
  return (
    <main className="bg-[url('/BG2.jpg')] bg-cover bg-center h-screen font-sans-serif">
      ...
      <div className="h-full bg-gradient-to-br from-black/60 via-black/40 to-transparent flex flex-col justify-center">
        <div className="flex flex-col justify-center items-start h-full pl-10 md:pl-16 lg:pl-24">
          <div className="xl:w-2/3 md:w-5/6 w-full px-2 md:px-0 xl:px-20 space-y-6">
            <h1 className="mt-12 text-3xl md:text-4xl xl:text-5xl font-bold text-transparent gap-2 flex flex-col bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 animate-gradient mb-6">
              <span className="md:text-nowrap flex text-wrap">
                EDUCATION FOR ALL.
              </span>

              <div className="text-nowrap flex md:flex-row flex-col">
